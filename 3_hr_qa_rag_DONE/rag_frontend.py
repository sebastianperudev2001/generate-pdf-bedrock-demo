...
st.set_page_config(page_title="Amber Q&A HR RAG Demo") ### Modify Heading

new_title = '<p style="font-family:sans-serif; color:Green; font-size: 42px;">Amber Q&A HR RAG Demo🎯</p>'
...
go_button = st.button("📌Learn GenAI with Sebastián Chávarry", type="primary") ### Button Name
